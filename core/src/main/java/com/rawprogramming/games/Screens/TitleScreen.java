...
public class TitleScreen implements Screen {
	...
	public void render(float delta) {
        ...
        game.batch.begin();
        font.draw(game.batch, titleText, camera.viewportWidth / 2 - titleWidth / 2, camera.viewportHeight / 2 + titleHeight / 2 + 5);
        font.draw(game.batch, startText, camera.viewportWidth / 2 - startWidth / 2, camera.viewportHeight / 2 - titleHeight / 2 - 5);
        game.batch.end();
